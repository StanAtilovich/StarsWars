...
import ru.stan.starswars.databinding.FragmentPlanetBinding
import javax.inject.Inject

@AndroidEntryPoint
class PlanetFragment : Fragment() {
    @Inject
    lateinit var VMFactory: PlanetViewModelFactory
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val rvAdapter = PlanetAdapter(viewModel)
        binding.rvPlanet.adapter = rvAdapter
